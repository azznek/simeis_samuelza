...
class Game:
    ...
    def upgrade_single_operator_if_possible(self):
        ...
        if actual_crew_augment[pilot_key]["rank"] <3 and actual_crew_augment[operator_key]["rank"] > 3:
    ...
    def buyRessource(self,ressource,amnt):
        self.get(f'/market/{self.sta}/buy/{ressource}/{amnt}')

    def sellRessource(self,ressource,amnt):
        self.get(f'/market/{self.sta}/sell/{ressource}/{amnt}')
